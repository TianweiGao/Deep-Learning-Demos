...
class PatchEmbedding(nn.Module):
    def __init__(self, img_size=96, patch_size=16, num_hidden=512):
        super().__init__()
        def _make_tuple(x):
        ...
        self.conv = nn.LazyConv2d(num_hidden, kernel_size=patch_size,
                                  stride=patch_size)
...
class ViTBlock(nn.Module):
    def __init__(self, num_hidden, norm_shape, mlp_num_hidden,
...
if __name__=="__main__":
    ...
    model = ViT(img_size, patch_size, num_hidden, mlp_num_hidden, num_heads,
